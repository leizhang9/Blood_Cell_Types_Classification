...
def main_page(request):
    ...
    pr_file_path = os.path.join("/data","group", "model" , "inputs" , "a_learning", "temp","pr_dataset.npy")
    al_file_path = os.path.join("/data","group", "model" , "inputs" , "a_learning", "temp","al_label.npy")
