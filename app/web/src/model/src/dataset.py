...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, usage: str, transform: Optional[Callable]=None) -> None:
        ...
        if self.usage == Usage.TRAINING:
            raw_data_path = os.path.join("/data","group", "model" , "inputs" , Usage.TRAINING)
        elif self.usage == Usage.PREDICTION:
            raw_data_path = os.path.join("/data","group", "model" , "inputs" , Usage.PREDICTION)
        else:
            raw_data_path = os.path.join("/data","group", "model" , "inputs" , Usage.A_LEARNING)
    ...
    def save_data(self, file) -> None:
        ...
        if self.usage == Usage.TRAINING or self.usage == Usage.A_LEARNING:
            ...
            file_path = os.path.join("/data","group", "model" , "inputs" , Usage.A_LEARNING, "dataset")
            ...
            file_path = os.path.join("/data","group", "model" , "inputs" , Usage.A_LEARNING, "temp")
            if not os.path.exists(file_path):
                os.makedirs(file_path)
