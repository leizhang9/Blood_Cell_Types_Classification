...
def upload_file(request):
    ...
    if request.method == "POST":
        ...
        destination = open(os.path.join("/data","group", "model" , "inputs" , "prediction", target_file.name), 'wb+')
...
def training(request):
    ...
    if os.path.exists(os.path.join("/data","group", "model" , "inputs" , "a_learning", "temp","al_label.npy")):
        delect_temp_file('plots')
        os.path.join("/data","group", "model" , "outputs" , "checkpoints")
        #main(False, True, False, BASE_DIR / 'model' / 'outputs' / 'checkpoints')
        main(False, True, False, os.path.join("/data","group", "model" , "outputs" , "checkpoints"))
        try:
    ...
    elif os.path.exists(os.path.join("/data","group", "model" , "inputs" , "training", "prediction.seg")):
        delect_temp_file('plots')
        delect_temp_file('temp')
...
def prediction(request):
    global FAILED_UPLOAD
    main(False, False, True, os.path.join("/data","group", "model" , "outputs" , "checkpoints"))
    try:
